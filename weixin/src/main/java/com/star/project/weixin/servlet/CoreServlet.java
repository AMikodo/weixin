package com.star.project.weixin.servlet;
...
import com.star.project.weixin.service.CoreService;
import com.star.project.weixin.util.SignUtil;


@Controller
@RequestMapping("weixin")
public class CoreServlet {
	//为什么在未实现Serialization   却写出serialVersionUID
	//需要对servlet序列化吗?
