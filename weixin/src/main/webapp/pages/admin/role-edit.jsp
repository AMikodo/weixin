...
<article class="page-container">
	<form class="form form-horizontal" id="form-role-edit" name="form-role-edit" method="post" action="role/updateto">
	<input type="hidden" name="rid" id="rid" value="${role.rid }">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">排序数值：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${role.sortnum }" placeholder="" id="sortnum" name="sortnum">
			</div>
		</div>
...
$(function(){
	...
	$("#form-role-edit").validate({
		...
		submitHandler:function(form){
			document.form-role-edit.submit();
			//$(form).ajaxSubmit();
