...
<article class="page-container">
	<form class="form form-horizontal" id="form-role-add" name="form-role-add" method="post" action="role/insert">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="sortnum" name="sortnum">
			</div>
		</div>
