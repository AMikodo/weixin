...
<div data-role="page" id="pageMain" style="">
	...
	<c:forEach items="${rank }" varStatus="status" var="l">
		...
		<c:choose>
			...
			<div style="border:0px solid blue;width:50px;height:50px;float: left;padding-left: 10px;">
	  			<img style="width:50px;height:50px;border-radius:25px;"src="${l.headimgurl}">
			</div>
			...
			<div style="text-align: right;padding-right:10px;white-space: nowrap;">
				<font style="font-size:28px;color:#E57330">${l.city }/${l.province }</font>场 
			</div>
		</div>
		</c:forEach>
	</div>
