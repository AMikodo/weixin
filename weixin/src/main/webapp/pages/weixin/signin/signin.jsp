...
function signIn(){
	...
	$.ajax({
		type:"post",
		url:"userSigninStatistics/getInfo",
		data:{"uid":uid},
		success:function(msg){
			
			$("#integral").html(msg.integral);
			if(msg.signincount>1){
				$("#imgs").attr("src","images/img_21.png");
			}else{
				$("#imgs").attr("src","images/img_2.png");
			}
			getSigninInfo();
		}
...
function getSigninInfo(){
	...
	$.ajax({
		type:"post",
		url:"userSigninStatistics/getSigninDateInfo",
		data:{"uid":uid},
		success:function(msg){
			
			//初始化签到表，为当前月份的签到情况
			var iDate = new Date();
			//var signStr=$("#dateUrlId").val(); var signStr="2018-11-1,2018-11-12,2019-07-25,2018-11-26,";
			var signStr=msg;
...
function getProportion(){
	...
	$.ajax({
		type:"post",
		url:"userSigninStatistics/getSigninProportion",
		data:{"uid":uid},
		success:function(msg){
			$("#proportion").html(msg)
		}
...
<input type="hidden" id="dateUrlId"> 
...
<body style=" background-color:#F5F5F5">
 ...
 <div>
 	<div style="text-align: center;background-color: #2a5e91;height: 50px;margin-bottom:2px;">
				...
				<span style="text-align:right;">&nbsp;&nbsp;&nbsp;<a style="font-size:18px;color:#fff" href="userSigninStatistics/rank" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;排行榜</a></span>
	</div>	
 </div>
    <div >
	...
	<div  style="width:64%; float:left;"  align="left">
		<!--  <div  align="center"> <img style="display:block;width:90%;" src="images/img_1.png" /></div>
		 -->
		  ...
		  <br/>
	 	 <div style="height:35px;margin-left: 5px;"> <img id="imgs" style="display:block;width:13%;float:left;"
		 ...
		 <span class="STYLE1">&nbsp;您共有<span id="integral" class="STYLE2"></span>积分啦!</span></div>
		 <div style="float:left; "> <span class="STYLE1">&nbsp;您已经击败全国<span id="proportion" class="STYLE2"></span>的用户啦!</span></div>
	</div>
