...
<body>
<input type="hidden" id="uname" value="${sessionScope.adminUser.uname }">
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs">后台管理</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a> 
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		...
		<dt><i class="Hui-iconfont">&#xe616;</i> 发单管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="meetingpubManager/list" data-title="发单管理" href="javascript:void(0)">发单管理</a></li>
			</ul>
		</dd>
		<dt><i class="Hui-iconfont">&#xe616;</i> 抢单管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="meetinggrabmManager/list" data-title="抢单管理" href="javascript:void(0)">抢单管理</a></li>
			</ul>
		</dd>
	</dl>
</div>
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<span title="我的桌面" data-href="pages/admin/welcome.jsp">我的桌面</span>
					<em></em></li>
		</ul>
	</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="pages/admin/welcome.jsp"></iframe>
	</div>
</div>
</section>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="js/H-ui/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
